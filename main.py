...
def on_startup():
    # Only create tables if they don't exist. NO MORE SEEDING DEFAULT WALLPAPERS.
    Base.metadata.create_all(bind=engine)
    print("Application started. Connected to database successfully.")
